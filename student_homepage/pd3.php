    ...
    <div class="small-container">
        <div class="row">
            ...
            <div class="col-2">
                ...
                <p class="text_gallery1">Women's College Top</p>
                <div class="small-container1">
                <p class="text_gallery3" id="initial">&#8369; 315.00 - &#8369; 485.00</p>
                  <p class="text_gallery2">Choose Size:</p>
                  <br>
                  <button id="wb_small" class="button" onclick="wb_small()">Small</button>
                  <button id="wb_medium" class="button" onclick="wb_medium()">Medium</button>
                  <button id="wb_large" class="button" onclick="wb_large()">Large</button>
                  <button id="wb_xl"class="button" onclick="wb_xl()">XL</button>
                  <button id="wb_two_xl" class="button" onclick="wb_two_xl()">2XL</button>
                  <button id="wb_three_xl" class="button" onclick="wb_three_xl()">3XL</button>
                  <button id="wb_four_xl" class="button" onclick="wb_four_xl()">4XL</button>
                  <button id="wb_five_xl" class="button" onclick="wb_five_xl()">5XL</button>
                  <button id="wb_six_xl" class="button" onclick="wb_six_xl()">6XL</button>
                  <button id="wb_ss" class="button1" onclick="wb_ss()">Special Size</button>
                  <br><br>
