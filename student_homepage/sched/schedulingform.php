<?php
	...
	if ($conn) {
		$schedid = $_GET['date'];	//date from calendar
...
<head>
	...
	<style>
		<?php include "sched-reservation.css" ?>
...
<body>
	<div id='updform-container'>
		<div class='updform-box'>
			...
			<form action='sched-reservation.php' method='POST' class='updateform'>
				...
				<input type='text' name='pickupschedule' class='inputbox long' required autocomplete='off' value='<?php echo $schedid;?>'>
				<br><br>
				...
				<p class="emailnote">Note: Please make sure your email is correct.
				<br><br>
				
				<!--Add id to the url-->
				<button class='upd-btn cncl'><a href='newCalendar.php?id=<?php echo $srcode;?>' class='cancelbtn'>Cancel</a></button>
